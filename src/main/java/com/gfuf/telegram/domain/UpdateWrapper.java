package com.gfuf.telegram.domain;
...
public class UpdateWrapper
{
    ...
    {
        String firstName = MessageUtils.defaultIfBlankNull(user.getFirstName());
        String secondName = MessageUtils.defaultIfBlankNull(" " + user.getLastName());
