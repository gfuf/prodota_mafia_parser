...
import com.gfuf.telegram.customer.dao.mapper.CustomerMapper;
...
@Repository
public class CustomerPostgresDAO extends JdbcDaoSupport implements CustomerDAO
{
    private static final CustomerMapper CUSTOMER_MAPPER = new CustomerMapper();

    @Autowired
    public CustomerPostgresDAO(DataSource dataSource)
    {
