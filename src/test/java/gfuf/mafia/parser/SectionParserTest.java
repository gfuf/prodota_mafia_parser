...
public class SectionParserTest
{
    ...
    public void testByMafiaPage() throws IOException
    {
        ...
        Set<Topic> testTopics = Set.of(createTopic("Регистрация№445", "https://prodota.ru/forum/topic/219579/?do=getNewComment", TopicStatus.OPEN),
                createTopic("Мафиозная флудилка т.18, Покорение статы в новом десятилетии", "https://prodota.ru/forum/topic/217907/?do=getNewComment", TopicStatus.OPEN),
                createTopic("Мафия 444. Трудно быть демоном. Ночи в 21-00", "https://prodota.ru/forum/topic/219541/?do=getNewComment", TopicStatus.CLOSED),
                createTopic("Стата версия 3.0 (черная)", "https://prodota.ru/forum/topic/217329/?do=getNewComment",TopicStatus.OPEN),
                createTopic("рейд за новичками (рега)", "https://prodota.ru/forum/topic/218642/?do=getNewComment",TopicStatus.OPEN),
                createTopic("Мафия 443: Туссент, Эрвелюс, Кровосиси", "https://prodota.ru/forum/topic/219239/?do=getNewComment",TopicStatus.CLOSED),
                createTopic("Мафия 442: Вас посетила Эрафия Police, впредь больше без матвинов фуллконфой", "https://prodota.ru/forum/topic/219101/?do=getNewComment", TopicStatus.CLOSED));
